...
// ─── Footer ───────────────────────────────────────────────────────────────────
/**
 * Dark-mode site footer — used on landing page and app pages.
 */
export function Footer() {
  ...
  return (
    <footer style={{ backgroundColor: "#0a0a0a", borderTop: "1px solid #1c1c1c" }}>
      <div className="mx-auto max-w-7xl px-5 py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
        {/* Brand */}
        ...
        <div className="flex items-center gap-6 text-xs" style={{ color: "#3f3f46" }}>
          ...
          <a href="#" className="transition-colors duration-150 hover:text-zinc-400">
            Privacy
          </a>
          <a href="#" className="transition-colors duration-150 hover:text-zinc-400">
            Terms
